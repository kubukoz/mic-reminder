...
isn't the highest-priority *connected* device from your list, either switches
to it automatically or shows a popover near the menu bar icon with a button
to switch to the better one — configurable via the "Automatically switch"
checkbox in Preferences (on by default).
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for running the app during
development.
